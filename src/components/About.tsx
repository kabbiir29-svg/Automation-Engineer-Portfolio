    ...
    <section id="about" className="py-28 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-[1.6fr,1.2fr] gap-14 items-start">
          ...
          >
            <h3 className="text-2xl md:text-4xl font-extrabold text-white leading-snug">
              Building{" "}
            ...
            <p>
              ...
              <span className="text-cyan-300">
                making operations smoother, faster, and more predictable.
              </span>
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 pt-4">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">
                  ...
                  requirements — and turning them into clear, repeatable automation
